...
TBRD_Board				boardArr[BRD_COUNT]={{0}};	// boardArr has BRD_COUNT entries
...
TBRD_Board				g_reinitBoardArr[BRD_COUNT]={{0}};		// Need to call _reinit().
...
BRD_API S32		STDCALL BRD_getInfo(BRD_Handle handle, BRD_Info *pInfo)
{

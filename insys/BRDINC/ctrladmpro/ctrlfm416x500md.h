...
typedef struct
{
	U32		power0;			//1 - включение модулятора 0
	U32		power1;			//1 - включение модулятора 1
	U32		mode0;			// режим модулятора 0: 0-низк. усиление, 1-высок. усиление
	U32		mode1;			// режим модулятора 1: 0-низк. усиление, 1-высок. усиление	
} BRD_DacSetModulator, *PBRD_DacSetModulator;

typedef struct
{	
	U32		isDac0;		// 1 - записать параметры для ЦАП0
	U32		param01;
	U32		param02;
	U32		isDac1;		// 1 - записать параметры для ЦАП1
	U32		param11;
	U32		param12;

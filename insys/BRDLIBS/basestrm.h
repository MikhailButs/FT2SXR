...
public:
	...
	HANDLE					m_hFileMap;			// Handle of shareable memory for "pShareControl"
	HANDLE					m_hMutex;			// Named Mutex to protect "pShareControl"
	char					m_rootName[128];	// Root Name of Blocks
	...
	BRD_BaseStrm( const char *devName, const char *rsrcName );

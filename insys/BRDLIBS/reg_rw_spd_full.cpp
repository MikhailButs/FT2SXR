	...
	do
	{
		...
		if( str[0] == _BRDC('[') )
		{
			...
			while( BRDC_fgets( str, 250, fh ) )
			{
				...
				GetKey( str, _BRDC("DEVBASEADR"), cfg.dev_baseadr, cfg.dev_baseadr );
				
				GetKey( str,_BRDC("32BITS"), cfg.fl_32bits, cfg.fl_32bits );
				
				GetKey( str,_BRDC("NUM"), cfg.num, cfg.num );
				
				GetKey( str,_BRDC("SYNCHR"), cfg.synchr, cfg.synchr );

...
ULONG CDdr4SdramSrv::GetCfgFromSpd(CModule* pModule, PDDR4SDRAMSRV_CFG pCfgSPD)
{
	...
	pCfgSPD->CapacityMbits = ((long long)1 << capacity[0]) * 256 * 1024 * 1024;
/*
...
int CDdr4SdramSrv::ExtraInit(CModule* pModule)
{
	...
	U64 virt_size = (U64)mask << 23;
        ...
        BRDC_printf(_BRDC("SDRAM Cfg Trd%ld: virt_size = %d MBytes (mask = 0x%04X, const = 0x%04X)\n"),
		m_MemTetrNum, U32(virt_size / 1024 / 1024), pMemSrvCfg->AdrMask, pMemSrvCfg->AdrConst);

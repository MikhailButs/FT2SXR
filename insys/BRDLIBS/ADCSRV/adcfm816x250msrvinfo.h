//****************** File Fm816x250mSrvInfo.h **********************************
//
//  Constants, structures & functions definitions
//	for API Property Dialog of FM816x250M service
//
// (C) InSys by Ekkore Aug 2011
//
//*******************************************************************************

#ifndef _FM816x250MSRVINFO_H
 #define _FM816x250MSRVINFO_H
...
typedef struct _FM816x250MSRV_Info {
	USHORT		Size;					// sizeof(FM816x250MSRV_Info)
...
} FM816x250MSRV_Info, *PFM816x250MSRV_Info;
//
#pragma pack()

#endif // _FM816x250MSRVINFO_H

//****************** File Fm212x1gSrvInfo.h **********************************
//
//  Constants, structures & functions definitions
//	for API Property Dialog of FM212x1G service
//
// (C) InSys by Ekkore Nov 2011
//
//*******************************************************************************

#ifndef _FM212x1GSRVINFO_H
 #define _FM212x1GSRVINFO_H
...
typedef struct _FM212x1GSRV_Info {
	USHORT		Size;					// sizeof(FM212x1GSRV_Info)
...
} FM212x1GSRV_Info, *PFM212x1GSRV_Info;
//
#pragma pack()

#endif // _FM212x1GSRVINFO_H

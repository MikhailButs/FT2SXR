//****************** File Fm214x250mSrvInfo.h **********************************
//
//  Constants, structures & functions definitions
//	for API Property Dialog of FM214x250M service
//
// (C) InSys by Ekkore Nov 2011
//
//*******************************************************************************

#ifndef _FM214x250MSRVINFO_H
 #define _FM214x250MSRVINFO_H
...
typedef struct _FM214X250MSRV_Info {
	USHORT		Size;					// sizeof(FM214X250MSRV_Info)
...
} FM214X250MSRV_Info, *PFM214X250MSRV_Info;
//
#pragma pack()

#endif // _FM214x250MSRVINFO_H

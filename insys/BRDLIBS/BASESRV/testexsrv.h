...
#include "ctrltestex.h"
#include "service.h"
#include "adm2if.h"
#include "mainregs.h"
#include "testexregs.h"

#define DLGDLLNAME_SIZE 64

const int TESTCTRL_TETR_ID = 0x4F;
const int DIO64OUT_TETR_ID = 0x12;
const int DIO64IN_TETR_ID = 0x13;

#pragma pack(push,1)

typedef struct _TESTEXSRV_CFG {
...
} TESTEXSRV_CFG, *PTESTEXSRV_CFG;

#pragma pack(pop)

class CTestExSrv : public CService
{

protected:

	long m_MainTetrNum;
	long m_TestCtrlTetrNum;
	long m_Dio64OutTetrNum;
	long m_Dio64InTetrNum;
...
public:
	...
	CTestExSrv(int idx, int srv_num, CModule* pModule, PTESTEXSRV_CFG pCfg); // constructor
	...
	int CtrlGetCheckError(
				void		*pDev,		// InfoSM or InfoBM
				void		*pServData,	// Specific Service Data
				ULONG		cmd,		// Command Code (from BRD_ctrl())
				void		*args 		// Command Arguments (from BRD_ctrl())
				);
	int CtrlGetCheckErMem(
				void		*pDev,		// InfoSM or InfoBM
				void		*pServData,	// Specific Service Data
				ULONG		cmd,		// Command Code (from BRD_ctrl())
				void		*args 		// Command Arguments (from BRD_ctrl())

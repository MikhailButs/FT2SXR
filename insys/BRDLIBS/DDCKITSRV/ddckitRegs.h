...
typedef enum _DDC640_NUM_CMD_REGS {
	DDCKIT_NCO_NB_ADDR	= 0x15, // Адрес NCO NB DDC
	DDCKIT_CONTROL1		= 0x17, // Регистр управления
	DDCKIT_NCO			= 0x18,	// Регистр для записи кода частоты NCO 
	DDCKIT_NCO_MASK		= 0x19, // Регистр маски при программировании WB DDC 
	DDCKIT_WRNCO_WB		= 0x1A, // Запись кода частоты в широкополосные DDC
	DDCKIT_WRNCO_NB		= 0x1B, // Запись кода частоты в узкополосные DDC
	DDCKIT_GAIN			= 0x1C, // Регистр для записи кода усиления
	DDCKIT_MASK			= 0x1D, // Регистр для записи маски каналов DDC

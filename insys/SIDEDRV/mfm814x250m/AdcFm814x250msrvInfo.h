//****************** File Fm814x250mSrvInfo.h **********************************
//
//  Constants, structures & functions definitions
//	for API Property Dialog of FM814x250M service
//
// (C) InSys by Ekkore Aug 2011
//
//*******************************************************************************

#ifndef _FM814x250MSRVINFO_H
 #define _FM814x250MSRVINFO_H
...
typedef struct _FM814X250MSRV_Info {
	USHORT		Size;					// sizeof(FM814X250MSRV_Info)
...
} FM814X250MSRV_Info, *PFM814X250MSRV_Info;
//
#pragma pack()

#endif // _FM814x250MSRVINFO_H
